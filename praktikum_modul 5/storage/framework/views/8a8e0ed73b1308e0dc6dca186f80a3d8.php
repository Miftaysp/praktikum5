...
unset($__errorArgs, $__bag); ?>" type="text"
                                name="email" id="email" value="<?php echo e(old('email',$employee->email)); ?>" placeholder="Enter Email">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 d-grid">
                            <button type="submit"  class="btn btn-dark btn-lg mt-3"> <a href="<?php echo e(route('employees.index')); ?>"></a><i class="bi-check-circle me-2"></i>
                                Save</button>
                        </div>
...
<?php /**PATH C:\Users\miftaysp28\praktikum-controller-view\resources\views/employee/edit.blade.php ENDPATH**/ ?>